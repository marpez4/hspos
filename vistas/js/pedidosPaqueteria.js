...
$(".tablas").on("click", ".btnEliminaPedidoPaqueteria", function () {
  ...
  swal({
    ...
    if (result.value) {
      window.location =
        "index.php?ruta=pedidosPaqueteria&idPedidoPaqueteria=" +
        idPedidoPaqueteria;
    }
  });
});
...
$(".tablas").on("click", ".btnImprimirPaqueteria", function () {
  ...
  window.open(
    "extensiones/tcpdf/pdf/envio-paqueteria.php?codigo=" + codigoPaqueteria,
    "_blank"
  );
});

$(".btnPedidoPaqueteria").click(function () {
